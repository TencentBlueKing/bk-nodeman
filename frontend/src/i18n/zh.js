...
export default {
  ...
  最新执行日志: '最新执行日志',
  业务拓扑: '业务拓扑',
  出口IP提示: `用于与GSE Server的数据传输，如果是公有云服务器，一般为 <b>公网IP</b> 或 <b>NAT IP</b>，请根据实际情况填写；<br />${$DHCP ? '支持 IPv4、IPv6' : '仅支持 IPv4'}。`,
  出口IP: '出口IP',
  ...
  补充说明tips: '\n补充说明：\n{0}',
  IP数量不一致: 'IP数量不一致',
  proxySetupHostIp: `用于与该云区域下 Agent 通信的内网IP地址， ${$DHCP ? '{1}{2}不能同时为空' : '仅支持 IPv4'}。`,
