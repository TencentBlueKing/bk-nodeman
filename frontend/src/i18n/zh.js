...
export default {
  ...
  云区域管理提示二: '',
  变更云区域原有的接入点: '变更云区域原有的接入点：',
  将会重装该云区域下所有Proxy: '将会重装该云区域下所有 Proxy',
  阿里云: '阿里云',
  AWS: 'AWS',
  腾讯云: '腾讯云',
  编辑云区域: '编辑云区域',
  ...
  proxy数量提示0: '！该云区域没有可用Proxy，建议安装 2 个以上保障更高可用性',
  确定删除: '确定删除？',
  Proxy状态: 'Proxy 状态',
  Proxy版本: 'Proxy 版本',
  重装: '重装',
  ...
  服务信息: '服务信息',
  内网IP: '内网IP',
  内网IP提示: '用于与Agent通信的IP地址',
  内网IPv6提示: '用于与Agent通信的IPv6地址',
  IP不符合规范: 'IP格式不正确',
  认证方式: '认证方式',
  密码密钥: '密码/密钥',
  登录IP提示: '目标主机的用于登录进行 Proxy 安装的 IP 地址，区别于记录在 CMDB 中的 IP；<br />支持 IP、IPv6。',
  外网IP: '外网IP',
  外网IPv6: '外网IPv6',
  内网网卡IP: '内网网卡IP',
  外网网卡IP: '外网网卡IP',
  ...
  最新执行日志: '最新执行日志',
  业务拓扑: '业务拓扑',
  出口IP提示: '用于与GSE Server的数据传输，如果是公有云服务器，一般为 <b>公网IP</b> 或 <b>NAT IP</b>，请根据实际情况填写；<br />支持 IP、IPv6。',
  出口IP: '出口IP',
  ...
  查看云区域权限: '查看云区域权限',
  选择日期范围: '选择日期范围',
  搜索任务ID执行者任务类型操作类型部署策略执行状态: '搜索任务ID、执行者、任务类型、操作类型、部署策略、执行状态',
  开始时间: '开始时间',
  执行账号: '执行账号',
  失败重试: '失败重试',
  Agent任务: 'Agent任务',
