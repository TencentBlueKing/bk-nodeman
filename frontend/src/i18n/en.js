...
export default {
  ...
  最新执行日志: 'Latest log',
  业务拓扑: 'Business topo',
  出口IP提示: `Used for data transmission with GSE Server. If it is a public cloud server, it is usually an intranet network IP or <b>NAT IP</b>. Please fill in according to the actual situation;<br />${$DHCP ? 'Supports multiple IPv4 addresses, separated by commas,<br /> Supports IPv6.<br />If there are multiple WAN IPs, fill them all in.' : 'IPv4 only (supports multiple IPv4 addresses, separated by commas)'}.`,
  出口IP: 'WAN IP',
  多外网IP提示: 'For display purposes only, modify through the WAN IP',
  多外网IP: 'Multiple public IP addresses',
  ...
  多个外网IP用英文逗号分隔: 'Multiple outer IPs are separated by English commas',
  认证资料期限: 'Expiration',
  过期: 'expired',
  有效: 'valid',
  ...
  搜索IP管控区域操作系统Agent状态: 'Search IP, BK-Net ID:IP, Agent status, plugin name and more',
