...
export default {
  ...
  删除: 'Delete',
  // 此处文案问题较大，暂时遗留。
  云区域管理提示一: 'A group of server units that can directly communicate with each other. such as a corporate LAN, the VPC (Virtual Private Network) of public cloud. Proxy: Proxy node for external communacation of cloud area.',
