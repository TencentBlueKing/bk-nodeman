...
export default {
  ...
  将会重装该管控区域下所有Proxy: 'It will reinstall all of Proxy under the "BK-Net"',
  阿里云: 'Ali Cloud',
  AWS: 'AWS',
  腾讯云: 'Tencent cloud',
  编辑管控区域: 'Edit BK-Net',
  ...
  安装通道Desc: 'In a special complex network, where the target host cannot directly connect with the host in the "BK-Net", you can install the agent by specifying an "install channel". The default option is "Default Chnnel".',
