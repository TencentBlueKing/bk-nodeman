...
class AgentViewSet(ModelViewSet, ValidationMixin):
    ...
    def parse(self, request):
        ...
        # 获取最新的agent上传包记录
        upload_package_obj: UploadPackage = GsePackageTools.get_latest_upload_record(
        ...
        sub_package_infos = {"description": artifact_meta_info.get("changelog"), "packages": package_dir_infos}
        ...
        return Response(pkg_manage.ParseResponseSerializer(sub_package_infos, context=package_mata_info).data)
