    ...
    def __post_init__(self):
        ...
        contexts: typing.List[context_dataclass.GseConfigContext] = [
            context_dataclass.AgentConfigContext(
                ...
                zone_id=str(self.host.bk_idc_area_id or self.ap.region_id),
                city_id=self.host.idc_city_id or self.ap.city_id,
            ...
            context_dataclass.DataConfigContext(
                ...
                enable_compression=["false", "true"][bool(self.host.extra_data.get("enable_compression", False))],
            ),
