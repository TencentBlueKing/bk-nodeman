...
from . import base, context_helper, legacy
...
class AgentStepAdapter:
    ...
    def config_tmpl_obj_gby_os_key(self) -> typing.Dict[str, typing.List[base.AgentConfigTemplate]]:
        ...
        return {
            ...
            self.get_os_key(constants.OsType.LINUX, constants.CpuType.x86_64): [
                base.AgentConfigTemplate(name="gse_agent.conf", content=context_helper.GSE_AGENT_CONFIG)
            ]
        }
    ...
    def _get_config(
        ...
        # 渲染配置
        ch: context_helper.AgentConfigContextHelper = context_helper.AgentConfigContextHelper(
