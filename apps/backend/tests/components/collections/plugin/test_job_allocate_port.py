...
from apps.backend.components.collections.plugin import JobAllocatePortComponent
...
class JobAllocatePortTest(TestCase, ComponentTestMixin):
    def setUp(self):
    ...
    def component_cls(self):
        return JobAllocatePortComponent
