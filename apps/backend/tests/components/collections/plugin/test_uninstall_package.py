...
from apps.backend.components.collections.plugin import UnInstallPackageComponent
...
class UnInstallPackageTest(TestCase, ComponentTestMixin):
    def setUp(self):
    ...
    def component_cls(self):
        return UnInstallPackageComponent
