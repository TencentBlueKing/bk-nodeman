...
from apps.backend.components.collections.plugin import RemoveConfigComponent
...
class RemoveConfigTest(TestCase, ComponentTestMixin):
    def setUp(self):
