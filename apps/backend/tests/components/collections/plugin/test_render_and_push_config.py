...
from apps.backend.components.collections.plugin import RenderAndPushConfigComponent
...
class RenderAndPushConfigTest(TestCase, ComponentTestMixin):
    def setUp(self):
    ...
    def component_cls(self):
        return RenderAndPushConfigComponent
