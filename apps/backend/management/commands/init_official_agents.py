...
from apps.backend.agent.agent_manage.pack_gse_client_with_config import GseClientPack
...
class Command(BaseCommand):
    ...
    def filter_cert_package(cls):
        ...
        try:
            ...
            raise CertFileNotFoundError(context="未匹配正确的Agent包")
        ...
        with atomic():
            upload_record = UploadPackage.create_record(
                ...
                action_type=constants.ProcType.AGENT.lower(),
