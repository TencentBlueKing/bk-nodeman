...
class Command(BaseCommand):
    def add_arguments(self, parser):
        ...
        parser.add_argument("-n", "--name", type=str, default="GSE2接入点", help="Name of AP")
        parser.add_argument(
            "-d", "--description", type=str, default="GSE2接入点", help="Description of AP, default: AP NAME."
        )
        parser.add_argument(
    ...
    def handle(self, **kwargs):
        gse_v1_ap: AccessPoint = AccessPoint.objects.filter(id=kwargs["reference_ap_id"]).first()
        if not gse_v1_ap:
        ...
        with atomic():
            ...
            gse_v2_ap.name: str = kwargs["name"]
            gse_v2_ap.description: str = kwargs.get("description") or kwargs["name"]
