...
class MetaHandler(APIModel):
    ...
    def fetch_job_list_condition(self, job_category, params=None):
        ...
        job_result = JobTools.get_job_queryset_with_biz_scope(all_biz_info, biz_info, biz_permission, params.get("bk_biz_ids"), kwargs)
        ...
        job_result = job_result.filter(job_type__in=job_type).values_list("created_by", "job_type", "status", "subscription_id")
