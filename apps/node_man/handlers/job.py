        ...
        for result in task_result["list"]:
            ...
            for step in sub_steps:
                if step["node_name"] in [
                    ...
                    "卸载Proxy",
                    "Uninstall Proxy",
                ] and (step["status"] in [constants.JobStatusType.RUNNING, constants.JobStatusType.SUCCESS]):
            ...
            instance_info.update(
                {
                    ...
                    "auth_type": host.get("auth_type", constants.AuthType.PASSWORD),
                    "account": host.get("account", constants.OS_ACCOUNT.get(host["os_type"], "root")),
                    "port": host.get("port"),
