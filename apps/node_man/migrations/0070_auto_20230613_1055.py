...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddField(
            model_name="cloud",
            name="gse_v1_ap_id",
            field=models.IntegerField(blank=True, null=True, verbose_name="GSE1.0接入点ID"),
        ),
        migrations.AddField(
            model_name="host",
            name="gse_v1_ap_id",
            field=models.IntegerField(blank=True, db_index=True, null=True, verbose_name="GSE1.0接入点ID"),
        ),
