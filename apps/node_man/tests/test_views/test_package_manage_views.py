...
class PackageManageViewsTestCaseUsingProxy(Proxy2StepAdapterTestCase):
    ...
    def test_list_with_filter_condition(self, *args, **kwargs):
        ...
        result = self.client.post(
            path="/api/agent/package/search/",
            data={"page": 1, "pagesize": 2, "tag_names": "stable", "project": "gse_proxy"},
        )
        self.assertEqual(len(result["data"]), 1)
        self.assertIn("stable", self.collect_all_tag_names(result["data"][0]["tags"]))
        result = self.client.post(
            path="/api/agent/package/search/",
            data={"page": 1, "pagesize": 2, "tag_names": "latest", "project": "gse_proxy"},
        )
        self.assertEqual(len(result["data"]), 1)
        self.assertIn("latest", self.collect_all_tag_names(result["data"][0]["tags"]))
        result = self.client.post(
            path="/api/agent/package/search/",
            data={"page": 1, "pagesize": 2, "tag_names": "test", "project": "gse_proxy"},
        )
        ...
        self.assertEqual(len(result["data"]), 1)
        self.assertEqual(result["data"][0]["os"], computer_os)
        self.assertEqual(result["data"][0]["cpu_arch"], cpu_arch)
        result = self.client.post(
            path="/api/agent/package/search/",
        ...
        self.assertEqual(len(result["data"]), 1)
        self.assertEqual(result["data"][0]["created_by"], gse_package.created_by)
        result = self.client.post(
            path="/api/agent/package/search/",
            data={"page": 1, "pagesize": 2, "created_by": "system", "project": "gse_proxy"},
        )
        self.assertEqual(len(result["data"]), 0)
        ...
        self.assertEqual(len(result["data"]), 1)
        self.assertEqual(result["data"][0]["is_ready"], True)
        result = self.client.post(
            path="/api/agent/package/search/",
            data={"page": 1, "pagesize": 2, "is_ready": "False", "project": "gse_proxy"},
        )
        self.assertEqual(len(result["data"]), 0)
        ...
        self.assertEqual(len(result["data"]), 1)
        self.assertEqual(result["data"][0]["version"], "1.0.1")
        result = self.client.post(
            path="/api/agent/package/search/",
            data={"page": 1, "pagesize": 2, "version": "1.0.2", "project": "gse_proxy"},
        )
        self.assertEqual(len(result["data"]), 0)
