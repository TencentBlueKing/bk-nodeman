...
class CCApiMockClient(utils.BaseMockClient):
    def __init__(
        ...
        self.push_host_identifier = self.generate_magic_mock(mock_return_obj=push_host_identifier_return)
        ...
        self.batch_update_host = self.generate_magic_mock(mock_return_obj=batch_update_host_return)
