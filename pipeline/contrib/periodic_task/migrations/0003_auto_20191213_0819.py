    ...
    operations = [
        ...
        migrations.AlterField(
            ...
            field=models.TextField(blank=True, default='[]',
                                   help_text='JSON encoded positional arguments', verbose_name='Arguments'),
        ),
        migrations.AlterField(
            model_name='djceleryperiodictask',
            name='kwargs',
            field=models.TextField(blank=True, default='{}',
                                   help_text='JSON encoded keyword arguments', verbose_name='Keyword arguments'),
        ),
        migrations.AlterField(
            model_name='intervalschedule',
            name='period',
            field=models.CharField(choices=[('days', 'Days'), ('hours', 'Hours'), ('minutes', 'Minutes'), (
                'seconds', 'Seconds'), ('microseconds', 'Microseconds')], max_length=24, verbose_name='period'),
        ),
        migrations.AlterField(
            model_name='periodictask',
            name='creator',
