    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('args', models.TextField(default=b'[]',
                                          help_text='JSON encoded positional arguments', verbose_name='Arguments', blank=True)),
                ('kwargs', models.TextField(default=b'{}', help_text='JSON encoded keyword arguments',
                                            verbose_name='Keyword arguments', blank=True)),
                ('queue', models.CharField(default=None, max_length=200, blank=True,
                                           help_text='Queue defined in CELERY_QUEUES', null=True, verbose_name='queue')),
                ...
                ('crontab', models.ForeignKey(blank=True, to='periodic_task.CrontabSchedule',
                                              help_text='Use one of interval/crontab', null=True, verbose_name='crontab', on_delete=models.CASCADE)),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('period', models.CharField(max_length=24, verbose_name='period', choices=[
                 (b'days', 'Days'), (b'hours', 'Hours'), (b'minutes', 'Minutes'), (b'seconds', 'Seconds'), (b'microseconds', 'Microseconds')])),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('celery_task', models.ForeignKey(verbose_name='celery \u5468\u671f\u4efb\u52a1\u5b9e\u4f8b',
                                                  to='periodic_task.DjCeleryPeriodicTask', null=True, on_delete=models.SET_NULL)),
                ('snapshot', models.ForeignKey(related_name='periodic_tasks',
                                               verbose_name='\u7528\u4e8e\u521b\u5efa\u6d41\u7a0b\u5b9e\u4f8b\u7684\u7ed3\u6784\u6570\u636e', to='pipeline.Snapshot', on_delete=models.DO_NOTHING)),
                ('template', models.ForeignKey(related_name='periodic_tasks', on_delete=django.db.models.deletion.SET_NULL,
                                               verbose_name='\u5468\u671f\u4efb\u52a1\u5bf9\u5e94\u7684\u6a21\u677f', to_field='template_id', to='pipeline.PipelineTemplate', null=True)),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('periodic_task', models.ForeignKey(related_name='instance_rel', verbose_name='\u5468\u671f\u4efb\u52a1',
                                                    to='periodic_task.PeriodicTask', null=True, on_delete=models.DO_NOTHING)),
                ('pipeline_instance', models.ForeignKey(related_name='periodic_task_rel', verbose_name='Pipeline \u5b9e\u4f8b',
                                                        to_field='instance_id', to='pipeline.PipelineInstance', null=True, on_delete=models.DO_NOTHING)),
            ],
        ),
        migrations.AddField(
            model_name='djceleryperiodictask',
            name='interval',
            field=models.ForeignKey(verbose_name='interval', blank=True,
                                    to='periodic_task.IntervalSchedule', null=True, on_delete=models.CASCADE),
        ),
    ]
