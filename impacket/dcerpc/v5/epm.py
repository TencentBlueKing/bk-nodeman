...
from impacket.dcerpc.v5.dtypes import LPBYTE, PUUID, ULONG, USHORT, UUID
...
from impacket.uuid import bin_to_string, uuidtup_to_bin
...
EPMFloors = [EPMRPCInterface, EPMRPCDataRepresentation, EPMFloor, EPMFloor, EPMFloor, EPMFloor]
...
def hept_lookup(
    destHost, inquiry_type=RPC_C_EP_ALL_ELTS, objectUUID=NULL, ifId=NULL, vers_option=RPC_C_VERS_ALL, dce=None
):
    if dce is None:
