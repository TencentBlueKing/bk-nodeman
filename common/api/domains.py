...
# 蓝鲸平台模块域名
MONITOR_APIGATEWAY_ROOT = gen_api_root("BKAPP_BK_MONITOR_APIGATEWAY", "monitor")
...
USER_APIGATEWAY_ROOT_V3 = os.getenv("BKAPP_BK_USER_APIGATEWAY")
USER_WEB_APIGATEWAY_ROOT_V3 = os.getenv("BKAPP_BK_USER_WEB_APIGATEWAY")
LOGIN_APIGATEWAY_ROOT_V3 = os.getenv("BKAPP_BK_LOGIN_APIGATEWAY")
APIGATEWAY_ROOT = os.getenv("BKAPP_BK_APIGATEWAY")
